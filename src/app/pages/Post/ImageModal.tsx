          ...
          <>
            {selectedImageIndex > 0 && (
              <button
                ...
                className='absolute left-4 top-1/2 transform -translate-y-1/2 text-white bg-black bg-opacity-50 hover:bg-opacity-70 rounded-full p-3 transition-colors shadow-lg z-10'
              >
            ...
            {selectedImageIndex < postImages.length - 1 && (
              <button
                ...
                className='absolute right-4 top-1/2 transform -translate-y-1/2 text-white bg-black bg-opacity-50 hover:bg-opacity-70 rounded-full p-3 transition-colors shadow-lg z-10'
              >
                <svg className='w-6 h-6' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
