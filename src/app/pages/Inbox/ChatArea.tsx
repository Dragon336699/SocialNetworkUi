            ...
            {isRecording ? (
              ...
              <>
                ...
                <div className='flex-1 relative'>
                  <div className='flex items-start bg-white rounded-[24px] px-4 py-2 border border-gray-200'>
                    <textarea
                      ref={textareaRef}
                      className='flex-1 bg-transparent text-sm outline-none placeholder-gray-500 resize-none overflow-hidden max-h-[100px]'
